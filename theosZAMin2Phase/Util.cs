    ...
    internal static class Util {
        ...
        */
        ...
        internal static string toFaceCube(CubieCube cc) {
            ...
            for (byte c = 0; c < 8; c++) {
                int j = cc.ca[c] & 0x7;// cornercubie with index j is at    // cornerposition with index c
            ...
            for (byte e = 0; e < 12; e++) {
                int j = cc.ea[e] >> 1;// edgecubie with index j is at edgeposition // with index e
        ...
        static byte setVal(int val0, int val, bool isEdge) => (byte)(isEdge ? (val << 1 | val0 & 1) : (val | val0 & 0xf8));
